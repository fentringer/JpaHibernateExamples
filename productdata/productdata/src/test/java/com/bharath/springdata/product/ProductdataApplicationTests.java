...
public class ProductdataApplicationTests {
	...
	public void testFindAllProductsByPrice(){
		System.out.println(repository.findAllProductsByPrice(800.00));
	}

	@Test
	public void testFindAllProductsCountPrice(){
		System.out.println(repository.findAllProductsCountPrice(800.00));
		System.out.println(repository.findAllProductsCountPrice(200.00));
	}
